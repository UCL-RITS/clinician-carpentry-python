...
> [Critical Care Health Informatics Collaborative ](https://pubmed.ncbi.nlm.nih.gov/29500026/).  
> Specifically, we use the following data files:
> - [gp_codes.csv]({{ page.root }}/gpcodes.csv)
> - [pc_area_codes.csv]({{ page.root }}/pc_area_codes.csv)
> - [synthetic_db.sqlite3]({{ page.root }}/data/synthetic_db.sqlite3)
>
> Please download them (by clicking on the corresponding links) and move them to the same directory, or
> [download all the files as a zip]({{ page.root }}/data/files-master.zip)
